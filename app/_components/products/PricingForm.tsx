  ...
  return (
    <section className="w-full px-4 py-10">
      <div className="mx-auto w-full max-w-5xl">
        <div className="overflow-hidden rounded-[30px] border border-goldDark/35 bg-linear-to-br from-white via-[#fff8f1] to-[#fff2e5] shadow-[0_18px_40px_#9d741021,0_12px_30px_#be123c14]">
          ...
          <form className="p-4 md:p-6">
                  ...
                  <div className="grid grid-cols-1 gap-3 md:grid-cols-[1.8fr_0.6fr_0.5fr]">
                    <div className="flex flex-col gap-1">
                      ...
                      <input
                        ...
                        className="h-14 w-full rounded-2xl border border-goldDark/20 bg-[#fffaf5] px-4 text-lg font-medium text-gray-700 outline-none"
                      />
                    </div>
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <input
                        ...
                        readOnly
                        aria-label="Cena"
                        className="h-14 w-full rounded-2xl border border-goldDark/30 bg-linear-to-b from-[#fff7e8] to-[#fff1d4] px-4 text-lg font-semibold text-goldDark outline-none"
                      />
                    </div>
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <input
                        ...
                        readOnly
                        aria-label="Akcia"
                        className="h-14 w-full rounded-2xl border border-redMain/25 bg-[#fff5f6] px-4 text-lg font-semibold text-redDark outline-none"
                      />
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-6 flex flex-col gap-4 border-t border-goldDark/20 pt-5 md:flex-row md:items-center md:justify-between">
              ...
              <button
                type="button"
                className="inline-flex h-12 items-center justify-center rounded-2xl border border-redMain/35 bg-linear-to-r from-redMain to-redDark px-6 text-sm font-semibold text-white shadow-[0_8px_20px_rgba(190,18,60,0.26)] transition duration-300 hover:scale-[1.02] hover:shadow-[0_12px_26px_rgba(190,18,60,0.32)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-goldDark/45 focus-visible:ring-offset-2 focus-visible:ring-offset-[#fff5ec] hover:cursor-pointer focus:ring active:scale-98"
              >
                Rezervovat termin
              </button>
            </div>
