...
export default function JaluproYoungEye_update_form({
  jaluproYoungEyeData,
  isAdmin,
}: JaluproYoungEyeUpdateFormProps) {
  ...
  function handleSubmit(formData: FormData) {
    startTransition(async () => {
      try {
        formData.set(
          "slug",
          (jaluproYoungEyeData as { slug?: string } | null)?.slug ??
            "jalupro-young-eye",
        );
        formData.set(
          "data",
        ...
        console.error(error);
        toast.error("Chyba pri ukladaní Jalupro Young Eye");
      }
    });
  }
